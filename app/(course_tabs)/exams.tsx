  ...
  const renderExamCard = (exam: ExamDetails) => (
    ...
    >
      ...
      <View className="p-4">
        ...
        <View className="flex-row items-center space-x-4 mb-3">
          ...
          <View className="flex-row items-center pr-1">
            ...
            <Text className="text-sm text-gray-700 font-medium">
              {exam.total_items} {exam.total_items === 1 ? "item" : "items"}
            </Text>
          </View>
        ...
        {/* Divider */}
        {exam.is_taken && <View className="border-t border-gray-200 my-3" />}
        ...
        {!exam.is_taken && (
          <View className="mt-3">
            ...
            >
              <Text className="text-white font-semibold">Start Exam</Text>
            </Pressable>
          </View>
        )}
      </View>
  ...
  return (
    <SafeAreaView className="flex-1">
      <ScrollView className="flex-1 bg-gray-100">
        <View className="p-4">
          <Text className="text-2xl font-bold mb-4">Exams</Text>
          <View className="mb-6 bg-gray-50 border border-gray-300 rounded-lg px-4 py-6 ">
            <Text className="text-lg font-semibold">Exam Instructions</Text>
            ...
            <Text className="text-gray-600 py-1">
              ...
              limited time to complete each exam.
            </Text>
            <Text className="text-gray-600 py-1">
              <MaterialCommunityIcons
          ...
          {isLoading && (
            <View className="flex-1 justify-center items-center py-8">
              ...
              <Text className="text-gray-500 mt-2">Loading exams...</Text>
            </View>
          )}
          ...
          {!isLoading && !isError && renderGroupedExams()}
        </View>
      </ScrollView>
    </SafeAreaView>
  );
