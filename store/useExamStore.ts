...
type ExamStore = {
  ...
  beginAttempt: (exam_id: number, instance_id: number) => void;
...
export const useExamStore = create<ExamStore>()(
  persist(
    (set) => ({
      ...
      beginAttempt: (exam_id, instance_id) =>
        set({ ...emptyAttempt, exam_id, instance_id, status: "starting" }),
